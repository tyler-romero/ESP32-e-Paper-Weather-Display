...
String City             = "CITY, ST";                      // Your home city See: http://bulk.openweathermap.org/sample/
String Country          = "U.S.";                            // Your _ISO-3166-1_two-letter_country_code country code, on OWM find your nearest city and the country code is displayed
...
int   gmtOffset_sec     = -28800;    // UK normal time is GMT, so GMT Offset is 0, for eastern US (-5Hrs) is typically -18000, Midwest is -21600
